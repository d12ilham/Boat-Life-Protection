  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-start py-4">
      ...
      <div className="w-full max-w-5xl mx-auto bg-white rounded-3xl border border-slate-200 shadow-xl relative z-0 flex flex-col animate-in zoom-in-98 duration-400">
        ...
        <div className="bg-slate-50/50 border-b border-slate-200/80 px-6 py-4 flex overflow-x-auto scrollbar-none gap-3 justify-start items-center select-none lg:justify-center">
          {[
            { num: 1, title: "Service Plan" },
            { num: 2, title: "Customer Details" },
            { num: 3, title: "Contract Review" },
            ...
            return (
              <div
                key={s.num}
                className={`flex items-center gap-2.5 px-4 py-2.5 rounded-full border transition-all duration-200 relative whitespace-nowrap text-xs sm:text-sm tracking-tight shadow-xs ${
                  isActive
